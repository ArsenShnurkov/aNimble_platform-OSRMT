...
includeTargets << new File(System.properties['base.dir'] + '/scripts/ExecuteDatabaseScriptsV0_5.groovy')

target ('main': "Load the Grails interactive shell") {
	depends( configureProxy, packageApp, classpath, loadApp, configureApp, main_anp_v0_0, main_anp_v0_1, main_anp_v0_2, main_anp_v0_3, main_anp_v0_4, main_anp_v0_5  )
