...
target ('main_anp_v0_5': "Load the Grails interactive shell") {
	depends( configureProxy, packageApp, classpath, loadApp, configureApp )

	println 'Called ExecuteDatabaseScriptsV0_5.groovy'	
	
	def data_files = ['data.sql']
	
	def schema_files = ['schema.sql']
	
	def version_folder = 'anp_v0_5'
...
setDefaultTarget(main_anp_v0_5)