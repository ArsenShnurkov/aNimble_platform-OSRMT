...
class ApplicationControl extends NimbleDomain {
   ...
   ApplicationControlTypeReference control_type_ref
   ...
   String toString(){
	...
	static fetchMode = [control_ref:'eager',control_type_ref:'eager']
  ...
  static mapping = {
      ...
      control_type_ref column:'control_type_ref_id'
      display_column column:'view_column'
      reference_group column:'control_format'
