...
<td class="buttonSeperator" width="1px" height="25px"></td>
<td id="AddSprint" class="buttonNotSelected" height="25px"><a href="#" onclick="location.href = '${grailsApplication.metadata['app.namespace']}/sprint/create?project_id=${session.curProject.id}';" class="buttonTitle" onMouseOver="selectButton('AddSprint');" onMouseOut="unselectButton('AddSprint');">Add</a></td>
<td class="buttonSeperator" width="1px" height="25px"></td>
...
<td id="UpdateSprint" class="buttonNotSelected" height="25px"><a href="#" onclick="location.href='${grailsApplication.metadata['app.namespace']}/${viewHelper.getControllerName(sprintInstance)}/edit/${sprintInstance.id}';" class="buttonTitle" onMouseOver="selectButton('UpdateSprint');" onMouseOut="unselectButton('UpdateSprint');">Update</a></td>
<td class="buttonSeperator" width="1px" height="25px"></td>
