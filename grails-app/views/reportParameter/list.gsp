                ...
                <table>
                    ...
                    <g:each in="${reportParameterInstanceList}" status="i" var="reportParameterInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td align="center"><a ${(i % 2) == 0 ? "class='oddLink'" : ""} href="#" onClick="location.href = '${grailsApplication.metadata['app.namespace']}/reportParameter/show/${reportParameterInstance.id}'">${reportParameterInstance.id}</a></td>
