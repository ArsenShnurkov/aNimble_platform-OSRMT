...
<td>
      ...
      <script type="text/javascript">
        ...
        <form class="jasperReport" name="test2" action="${grailsApplication.metadata['app.namespace']}/jasper/">
...
<button title="HTML" onclick="return submit_test2(this)" type="button"><img border="0"  alt="HTML" src="${grailsApplication.metadata['app.namespace']}/plugins/jasper-1.1.3/images/icons/HTML.gif" /> Preview</button>

        &nbsp;
        <a href="#" class="jasperButton" title="XLS" onclick="return submit_test2(this)">
        <img border="0"  alt="XLS" src="${grailsApplication.metadata['app.namespace']}/plugins/jasper-1.1.3/images/icons/XLS.gif" /></a>
       &nbsp;
        <a href="#" class="jasperButton" title="PDF" onclick="submit_test2(this)">
        <img border="0"  alt="PDF" src="${grailsApplication.metadata['app.namespace']}/plugins/jasper-1.1.3/images/icons/PDF.gif" /></a>
</form>
...
<iframe id='reportFrame' onload="showMsg();" width="80%" height="60%" src="${grailsApplication.metadata['app.namespace']}/jasper/?_name=&_format=HTML&_file=test2&product_ref_id=6094029"></iframe>
