...
%>
		...
		<div dojoType="dojo.data.ItemFileReadStore"
		     url="${grailsApplication.metadata['app.namespace']}/reports/menu_tree?${System.currentTimeMillis()}&location=${request.viewHelper.includeParams?.location}" jsid="reportStore" preventCache="true"></div>
		<div dojoType="dijit.Tree" store="reportStore" labelAttr="name"
		     ...
		     <script type="dojo/method" event="onClick" args="item">
		        var thisURL = "${grailsApplication.metadata['app.namespace']}/reports/show/"+  reportStore.getIdentity(item) + "?location=${request.viewHelper.includeParams?.location}";
