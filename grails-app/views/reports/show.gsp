...
<form class="jasperReport" name="jasperReport" id="jasperReport" action="${grailsApplication.metadata['app.namespace']}/jasper/">
...
<input type="hidden" name="logo" value="${grailsApplication.metadata['app.namespace']}/images/logo_magneto.png"/>
...
<td class="buttonSeperator" width="1px" height="25px"></td>
<td id="DOCX" class="buttonNotSelected" height="25px"><a href="#" onclick="runJasperReport('DOCX','${reportInstance.report_language_ref.display_code}','${reportInstance.file_name}','${reportInstance.query_name}',document.getElementById('jasperReport'));" class="buttonTitle" onMouseOver="selectButton('DOCX');" onMouseOut="unselectButton('DOCX');">Export Doc</a></td>
<td class="buttonSeperator" width="1px" height="25px"></td>
</tr>
</table>
                ...
                <table width="100%" height="100%">           
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">
								...
								<iframe id="reportFrame" width="100%" height="100%" src="${grailsApplication.metadata['app.namespace']}/images/clear.gif"></iframe>
