...
%>
		...
		<div dojoType="dojo.data.ItemFileReadStore"
		     url="${grailsApplication.metadata['app.namespace']}/project/menu_tree?${System.currentTimeMillis()}" jsid="popStore" preventCache="true"></div>
		<div dojoType="dijit.Tree" store="popStore" labelAttr="name"
		     ...
		     <script type="dojo/method" event="onClick" args="item">
               ...
               //http://localhost:8080${grailsApplication.metadata['app.namespace']}/project/show/101
               //alert("${grailsApplication.metadata['app.namespace']}/" + popStore.getValue(item, "type") + "/show_viewonly/"+  popStore.getIdentity(item) + "?viewOnly=true");
    			dijit.byId("ProjectView").setHref("${grailsApplication.metadata['app.namespace']}/" + popStore.getValue(item, "type") + "/show_viewonly/"+  popStore.getIdentity(item) + "?viewOnly=true");
