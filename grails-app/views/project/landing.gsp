...
<div id="ProjectLanding" style="float:left;height:80%;width:95%;" class="landing">
	...
	<div id="mainTabContainer" dojoType="dijit.layout.TabContainer" class="tabContainer"
			   style="width: 100%; height:100%;">
				      ...
				      <div id="ProjectMaintain" dojoType="dijit.layout.ContentPane" title="Project Detail"
		    				...
		    				href="${grailsApplication.metadata['app.namespace']}/project/show/${params.id}">
				      </div>
				      ...
				      <div id="Releases" dojoType="dijit.layout.ContentPane" style="width: 100%; height: 80%;"
				           ...
				           href="${grailsApplication.metadata['app.namespace']}/release/index/${params.id}?project_id=${params.id}"
	...
	<% if (projectInstance instanceof AgileProject) { %>
				      <div id="Sprints" dojoType="dijit.layout.ContentPane" style="width: 100%; height: 80%;"
				           ...
				           href="${grailsApplication.metadata['app.namespace']}/sprint/index/${params.id}?projectType=agileProject&project_id=${params.id}"
				      ...
				      <div id="ProductBacklog" dojoType="dijit.layout.ContentPane" style="width: 100%; height: 80%;"
				           ...
				           href="${grailsApplication.metadata['app.namespace']}/productBacklogArtifact/list/${params.id}?projectType=agileProject&project_id=${params.id}"
				           selected="${request.viewHelper.isTabSelected(ViewTabs.PROJECT_PRODUCT_BACKLOG)}">
				      </div>

				      <div id="Bugs" dojoType="dijit.layout.ContentPane" style="width: 100%; height: 80%;"
				           preventCache="true" title="Bugs"
				           href="${grailsApplication.metadata['app.namespace']}/issue/list?location=BUGS"
				           selected="${request.viewHelper.isTabSelected(ViewTabs.PROJECT_BUGS)}">
	...
	<% if (projectInstance instanceof WaterfallProject) { %>
				      <div id="Artifacts" dojoType="dijit.layout.ContentPane" style="width: 100%; height: 80%;"
				           ...
				           href="${grailsApplication.metadata['app.namespace']}/artifact/list/${params.id}?projectType=waterfallProject&project_id=${params.id}"
	...
	<% } %>
				      ...
				      <div id="Reports" dojoType="dijit.layout.ContentPane" style="width: 100%; height: 80%;"
				           ...
				           href="${grailsApplication.metadata['app.namespace']}/reports/list?location=PROJECTS"
