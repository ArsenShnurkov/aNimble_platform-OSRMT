...
<td id="AddArtifact" class="buttonNotSelected" height="25px"><a href="#" onclick="location.href = '${grailsApplication.metadata['app.namespace']}/productBacklogArtifact/create?project_id=${session.curProject.id}';" class="buttonTitle" onMouseOver="selectButton('AddArtifact');" onMouseOut="unselectButton('AddArtifact');">Add Backlog Artifact</a></td>
<td class="buttonSeperator" width="1px" height="25px"></td>
...
<td id="AddTask" class="buttonNotSelected" height="25px"><a href="#" onclick="location.href = '${grailsApplication.metadata['app.namespace']}/taskArtifact/create?project_id=${session.curProject.id}&parent_id=${viewHelper?.getArtifactParentId()}';" class="buttonTitle" onMouseOver="selectButton('AddTask');" onMouseOut="unselectButton('AddTask');">Add Task</a></td>
<td class="buttonSeperator" width="1px" height="25px"></td>
			<% } %>

<td id="UpdateArtifact" class="buttonNotSelected" height="25px"><a href="#" onclick="location.href='${grailsApplication.metadata['app.namespace']}/${viewHelper.getArtifactControllerName()}/edit/${artifactInstance.id}';" class="buttonTitle" onMouseOver="selectButton('UpdateArtifact');" onMouseOut="unselectButton('UpdateArtifact');">Update</a></td>
<td class="buttonSeperator" width="1px" height="25px"></td>
...
<td id="Project" class="buttonNotSelected" height="25px"><a href="#" onclick="location.href = '${grailsApplication.metadata['app.namespace']}/${session.curProject.projectType}/index/${session.curProject.id}';" class="buttonTitle" onMouseOver="selectButton('Project');" onMouseOut="unselectButton('Project');">Show Project</a></td>
<td class="buttonSeperator" width="1px" height="25px"></td>
...
<td id="DesignAdd" class="buttonNotSelected" height="25px" nowrap><a href="#" onclick="location.href = '${grailsApplication.metadata['app.namespace']}/designArtifact/create?project_id=${session.curProject.id}';" class="buttonTitle" onMouseOver="selectButton('DesignAdd');" onMouseOut="unselectButton('DesignAdd');">Add Design</a></td>
<td class="buttonSeperator" width="1px" height="25px"></td>
<td id="FeatureAdd" class="buttonNotSelected" height="25px" nowrap><a href="#" onclick="location.href = '${grailsApplication.metadata['app.namespace']}/featureArtifact/create?project_id=${session.curProject.id}';" class="buttonTitle" onMouseOver="selectButton('FeatureAdd');" onMouseOut="unselectButton('FeatureAdd');">Add Feature</a></td>
<td class="buttonSeperator" width="1px" height="25px"></td>
<td id="ImplementationAdd" class="buttonNotSelected" height="25px" nowrap><a href="#" onclick="location.href = '${grailsApplication.metadata['app.namespace']}/implementationArtifact/create?project_id=${session.curProject.id}';" class="buttonTitle" onMouseOver="selectButton('ImplementationAdd');" onMouseOut="unselectButton('ImplementationAdd');">Add Implementation</a></td>
<td class="buttonSeperator" width="1px" height="25px"></td>
<td id="RequirementAdd" class="buttonNotSelected" height="25px" nowrap><a href="#" onclick="location.href = '${grailsApplication.metadata['app.namespace']}/requirementArtifact/create?project_id=${session.curProject.id}';" class="buttonTitle" onMouseOver="selectButton('RequirementAdd');" onMouseOut="unselectButton('RequirementAdd');">Add Requirement</a></td>
<td class="buttonSeperator" width="1px" height="25px"></td>
<td id="TestCaseAdd" class="buttonNotSelected" height="25px" nowrap><a href="#" onclick="location.href = '${grailsApplication.metadata['app.namespace']}/testCaseArtifact/create?project_id=${session.curProject.id}';" class="buttonTitle" onMouseOver="selectButton('TestCaseAdd');" onMouseOut="unselectButton('TestCaseAdd');">Add Test Case</a></td>
<td class="buttonSeperator" width="1px" height="25px"></td>
</tr>
