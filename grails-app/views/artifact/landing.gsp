			...
			<div id="mainTabContainer" dojoType="dijit.layout.TabContainer"
			   style="border: 0px; width: 100%; height: 100%;" class="tabContainer">
				      ...
				      style="width: 100%; height: 80%;"
				       ...
				       href="${grailsApplication.metadata['app.namespace']}/artifact/show/${params.id}?parent_id=${viewHelper.getArtifactParentId()}">
				      </div>

				      <div id="History" dojoType="dijit.layout.ContentPane" style="width: 100%; height: 80%;"
				           preventCache="true" title="History"
				           href="${grailsApplication.metadata['app.namespace']}/artifactHistory/list?artifact_id=${viewHelper.getArtifactId()}"
				      ...
				      <div id="Dependencies" dojoType="dijit.layout.ContentPane" style="width: 100%; height: 80%;"
				           ...
				           href="${grailsApplication.metadata['app.namespace']}/artifactTree/list?artifact_id=${viewHelper.getArtifactId()}"
				      ...
				      <div id="Reports" dojoType="dijit.layout.ContentPane" style="width: 100%; height: 80%;"
				           ...
				           href="${grailsApplication.metadata['app.namespace']}/reports/list?location=ARTIFACTS"
