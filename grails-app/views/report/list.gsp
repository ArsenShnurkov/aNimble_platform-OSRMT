                ...
                <table>
                    ...
                    <g:each in="${reportInstanceList}" status="i" var="reportInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td align="center"><a ${(i % 2) == 0 ? "class='oddLink'" : ""} href="#" onClick="location='${grailsApplication.metadata['app.namespace']}/report/show/${reportInstance.id}'">${reportInstance.id}</a></td>
