                ...
                <table>
                    ...
                    <g:each in="${myActiveArtifactInstanceList}" status="i" var="artifactInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td align="center">&nbsp;<a ${(i % 2) == 0 ? "class='oddLink'" : ""} href="#" onClick="location='${grailsApplication.metadata['app.namespace']}/${request.viewHelper.getControllerName(artifactInstance)}/index/${artifactInstance.id}'">${artifactInstance.id}</a></td>
