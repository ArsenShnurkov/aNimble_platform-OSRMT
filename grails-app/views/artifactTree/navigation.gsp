...
<td id="AddArtifactTree" class="buttonNotSelected" height="25px"><a href="#" onclick="location.href = '${grailsApplication.metadata['app.namespace']}/artifactTree/create?artifactView=false';" class="buttonTitle" onMouseOver="selectButton('AddArtifactTree');" onMouseOut="unselectButton('AddArtifactTree');">Add</a></td>
<td class="buttonSeperator" width="1px" height="25px"></td>
<% } %>
