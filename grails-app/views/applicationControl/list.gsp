                ...
                <table>
                    ...
                    <g:each in="${applicationControlInstanceList}" status="i" var="applicationControlInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td align="center"><a ${(i % 2) == 0 ? "class='oddLink'" : ""} href="#" onClick="location = '${grailsApplication.metadata['app.namespace']}/applicationControl/show/${applicationControlInstance.id}'">${applicationControlInstance?.id}</a></td>                        
