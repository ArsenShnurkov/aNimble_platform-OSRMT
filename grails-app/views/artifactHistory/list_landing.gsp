                    ...
                    <g:each in="${artHistoryInstanceList}" status="i" var="artHistoryInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>
								...
								<td id="ShowArtHist${artHistoryInstance.id}" class="buttonNotSelected" height="25px"><a href="#" href="#" onclick="showModal('modal_window','${grailsApplication.metadata['app.namespace']}/artifactHistory/show/${artHistoryInstance.id}');" class="buttonTitle" onMouseOver="selectButton('ShowArtHist${artHistoryInstance.id}');" onMouseOut="unselectButton('ShowArtHist${artHistoryInstance.id}');">Show</a></td>
								<td class="buttonSeperator" width="1px" height="25px"></td>
								<td id="CompareArtHist${artHistoryInstance.id}" class="buttonNotSelected" height="25px"><a href="#" onclick="showModal('modal_window','${grailsApplication.metadata['app.namespace']}/artifactHistory/compare/${artHistoryInstance.id}');" class="buttonTitle" onMouseOver="selectButton('CompareArtHist${artHistoryInstance.id}');" onMouseOut="unselectButton('CompareArtHist${artHistoryInstance.id}');">Compare</a></td>
								<td class="buttonSeperator" width="1px" height="25px"></td>
								<td id="RollbackArtHist${artHistoryInstance.id}" class="buttonNotSelected" height="25px"><a href="#" onclick="location.href = '${grailsApplication.metadata['app.namespace']}/${viewHelper.getControllerName(viewHelper.getSession()?.curArtifact?.artifact_type)}/rollback/${artHistoryInstance.id}';" class="buttonTitle" onMouseOver="selectButton('RollbackArtHist${artHistoryInstance.id}');" onMouseOut="unselectButton('RollbackArtHist${artHistoryInstance.id}');">Rollback</a></td>
								<td class="buttonSeperator" width="1px" height="25px"></td>
								</tr></table>  
