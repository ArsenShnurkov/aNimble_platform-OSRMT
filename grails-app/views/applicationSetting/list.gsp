                ...
                <table>
                    ...
                    <g:each in="${applicationSettingInstanceList}" status="i" var="applicationSettingInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td align="center">&nbsp;<a ${(i % 2) == 0 ? "class='oddLink'" : ""} href="#" onClick="location='${grailsApplication.metadata['app.namespace']}/applicationSetting/show/${applicationSettingInstance.id}'">${applicationSettingInstance.id}</a></td>
