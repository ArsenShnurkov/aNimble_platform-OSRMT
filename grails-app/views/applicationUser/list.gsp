                ...
                <table>
                    ...
                    <g:each in="${applicationUserInstanceList}" status="i" var="applicationUserInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td align="center"><a ${(i % 2) == 0 ? "class='oddLink'" : ""} href="#" onClick="location.href = '${grailsApplication.metadata['app.namespace']}/applicationUser/show/${applicationUserInstance.id}'">${applicationUserInstance.id}</a></td>                        
