...
<td class="buttonSeperator" width="1px" height="25px"></td>
<td id="AddRelease" class="buttonNotSelected" height="25px"><a href="#" onclick="location.href = '${grailsApplication.metadata['app.namespace']}/release/create?project_id=${session.curProject.id}';" class="buttonTitle" onMouseOver="selectButton('AddRelease');" onMouseOut="unselectButton('AddRelease');">Add</a></td>
<td class="buttonSeperator" width="1px" height="25px"></td>
...
<td id="UpdateRelease" class="buttonNotSelected" height="25px"><a href="#" onclick="location.href='${grailsApplication.metadata['app.namespace']}/${viewHelper.getControllerName(releaseInstance)}/edit/${releaseInstance.id}';" class="buttonTitle" onMouseOver="selectButton('UpdateRelease');" onMouseOut="unselectButton('UpdateRelease');">Update</a></td>
<td class="buttonSeperator" width="1px" height="25px"></td>
