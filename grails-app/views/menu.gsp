...
<td class="menubuttonSeperator" width="3px" height="40px"></td>
<td id="Dashboard" class="menubuttonNotSelected" width="40px" height="40px" style="white-space:nowrap;"><a href="#" onclick="location.href='${grailsApplication.metadata['app.namespace']}/dashboard';" class="buttonTitle" onMouseOver="selectMenuButton('Dashboard');" onMouseOut="unselectMenuButton('Dashboard');"><image src="${grailsApplication.metadata['app.namespace']}/images/dashboard.png" border="0">&nbsp;Dashboard</a></td>
<td class="menubuttonSeperator" width="3px" height="40px"></td>
<td id="Projects" class="menubuttonNotSelected" width="40px" height="40px" style="white-space:nowrap;"><a href="#" onclick="location.href='${grailsApplication.metadata['app.namespace']}/project';" class="buttonTitle" onMouseOver="selectMenuButton('Projects');" onMouseOut="unselectMenuButton('Projects');"><image src="${grailsApplication.metadata['app.namespace']}/images/projects.png" border="0">&nbsp;Projects</a></td>
<td class="menubuttonSeperator" width="3px" height="40px"></td>
<td id="Reports" class="menubuttonNotSelected" width="40px" height="40px" style="white-space:nowrap;"><a href="#" onclick="location.href='${grailsApplication.metadata['app.namespace']}/reports?location=REPORTS';" class="buttonTitle" onMouseOver="selectMenuButton('Reports');" onMouseOut="unselectMenuButton('Reports');"><image src="${grailsApplication.metadata['app.namespace']}/images/reports.png" border="0">&nbsp;Reports</a></td>
<td class="menubuttonSeperator" width="3px" height="40px"></td>
<sec:access expression="hasRole('ROLE_ADMIN')">
<td id="Administration" class="menubuttonNotSelected" width="40px" height="40px" style="white-space:nowrap;"><a href="#" onclick="location.href='${grailsApplication.metadata['app.namespace']}/administration';" class="buttonTitle" onMouseOver="selectMenuButton('Administration');" onMouseOut="unselectMenuButton('Administration');"><image src="${grailsApplication.metadata['app.namespace']}/images/administration.png" border="0">&nbsp;Administration</a></td>
<td class="menubuttonSeperator" width="3px" height="40px"></td>
</sec:access>
<td id="Preferences" class="menubuttonNotSelected" width="40px" height="40px" style="white-space:nowrap;"><a href="#" onclick="location.href='${grailsApplication.metadata['app.namespace']}';" class="buttonTitle" onMouseOver="selectMenuButton('Preferences');" onMouseOut="unselectMenuButton('Preferences');"><image src="${grailsApplication.metadata['app.namespace']}/images/preferences.png" border="0">&nbsp;Preferences</a></td>
<td class="menubuttonSeperator" width="3px" height="40px"></td>
<td id="Help" class="menubuttonNotSelected" width="40px" height="40px" style="white-space:nowrap;"><a href="http://animbleplatform.ideastub.com?helpKey=${vh.getApplicationSetting('HELPKEY')}" target="_blank" class="buttonTitle" onMouseOver="selectMenuButton('Help');" onMouseOut="unselectMenuButton('Help');"><image src="${grailsApplication.metadata['app.namespace']}/images/help.png" border="0">&nbsp;Help</a></td>
<td class="menubuttonSeperator" width="3px" height="40px"></td>
<td class="menubuttonSelected" width="3px" height="40px"></td>
<td class="menubuttonSeperator" width="3px" height="40px"></td>
...
<td class="menubarTile" height="40px" valign="middle" align="center">
    <g:form url='[controller: "search", action: "index"]' id="searchForm" name="searchForm" method="get">
        ...
        <td valign="middle" nowrap>
        	...
        	<image style="vertical-align:middle;" height="28px" src="${grailsApplication.metadata['app.namespace']}/images/search_button_selected.png" onMouseOver="this.src='${grailsApplication.metadata['app.namespace']}/images/search_button_not_selected.png';" onMouseOut="this.src='${grailsApplication.metadata['app.namespace']}/images/search_button_selected.png';">
        	</a>
        </td>
        </tr>
        </table>
