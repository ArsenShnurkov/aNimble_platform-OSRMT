...
//	}
    ...
    function debugObject(someObject){
		...
		function setBreadCrumbs(breadCrumbsText,breadCrumbsLink){
			dojo.byId("BreadCrumbs").innerHTML = "<span class='"+ getBreakCrumbColorClass() + "'><a href='" + serverURL + "/" + breadCrumbsLink + "'><img src='" + serverURL + "/images/breadcrumb.png' alt='Bread Crumb' border='0'/> " + breadCrumbsText + "</a></span>";
			currentBreadCrumb++;
		}

		function addToBreadCrumbs(breadCrumbsText,breadCrumbsLink){
			dojo.byId("BreadCrumbs").innerHTML = dojo.byId("BreadCrumbs").innerHTML + " <span class='"+ getBreakCrumbColorClass() + "'><a href='" + serverURL + "/" + breadCrumbsLink + "'><img src='" + serverURL + "/images/breadcrumb.png' alt='Bread Crumb' border='0'/> " + breadCrumbsText + "</a></span>";
			currentBreadCrumb++;
		}
      ...
      var addl_params = "";
		for(i=0; i<formObject.elements.length; i++)
		{
      	...
      	if (reportLanguage=='SQL'){
    	  	document.getElementById("reportFrame").src = serverURL + "/jasper/?_name=&_format=" + format + "&_file="+ fileName + addl_params;
      	} else {
	      	document.getElementById("reportFrame").src = serverURL + "/reportQuery/" + queryName + "/?_name=&_format=" + format + "&_file="+ fileName + addl_params;
      	}
